...
const transactionController = {
    ...
    transfer: async (req, res) => {
        ...
        const { receiver_identifier, amount, note, reference_code } = req.body;
        ...
        try {
            const result = await txService.transfer(senderId, receiver_identifier, bigAmount, note, reference_code);
