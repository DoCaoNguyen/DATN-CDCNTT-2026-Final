...
const ERROR_MAPPINGS = {
    ...
    'USER_PENDING_VERIFY': [403, 'USER_PENDING_VERIFY', 'Tài khoản của bạn đang chờ kích hoạt.'],
    'USER_CREATED_OTP_SEND_FAILED': [502, 'USER_CREATED_OTP_SEND_FAILED', 'Tạo người dùng thành công nhưng gửi mã xác minh thất bại'],
    'Invalid_Or_Used_Verify_Token': [400, 'VERIFY_TOKEN_INVALID', 'Mã xác minh không hợp lệ hoặc đã được sử dụng'],
    'Invalid_Verify_Token': [400, 'VERIFY_TOKEN_INVALID', 'Mã xác minh không hợp lệ'],
