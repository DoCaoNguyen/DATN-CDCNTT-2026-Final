...
const authController = {
    ...
    verifyOtp: async (req, res) => {
        ...
        try {
            ...
            // 1. Nếu bị khóa (Trường hợp sai lần thứ 5 hoặc đang trong 30 phút)
            ...
            // 2. Nếu sai mã nhưng vẫn còn số lần thử (Trường hợp 1->4)
            if (error.message === 'OTP_Invalid') {
                return res.status(400).json({ 
                    error: 'Mã OTP không chính xác',
                    remainingAttempts: error.remainingAttempts // Gửi biến này về cho Flutter
                });
            }
    ...
    login: async (req, res) => {
        ...
        try {
            ...
            // Xử lý 2: Sai mật khẩu nhưng vẫn còn cơ hội
            ...
            // Xử lý 3: Lỗi tài khoản vô hiệu hóa hoặc hệ thống
