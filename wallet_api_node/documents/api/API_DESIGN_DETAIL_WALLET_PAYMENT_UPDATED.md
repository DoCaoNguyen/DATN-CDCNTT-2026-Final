...
> Ghi chú: Payload/response ưu tiên dùng `snake\\\_case` và bám theo `ewallet\_db.sql`.
...
```json
{
  ...
  "data": {
    ...
    "method": "SANDBOX\\\_BANK",
    "status": "SUCCESS",
    "ledger\\\_transaction\\\_id": "00000000-0000-0000-0000-000000000401",
...
```json
{
  ...
  "data": {
    ...
    "description": "Chuyen tien an trua",
    "status": "SUCCESS",
    "ledger\\\_transaction\\\_id": "00000000-0000-0000-0000-000000000402",
...
```json
{
  "payment\\\_order\\\_id": "00000000-0000-0000-0000-000000000701",
  "amount": 100000,
  "reason": "Khach huy mot phan don hang"
}
```
