...
> Căn cứ thiết kế: FRS tổng quan, FRS module, `ewallet_db.sql`, `ewallet_sample-data.sql`, và API conventions của project.
...
- Login sai nhiều lần phải ghi `auth_login_attempts`.
...
| `db_wallets_demo_v2.sql` | Schema DB |
| `db_wallets_demo_v2.sample-data.sql` | Dữ liệu mẫu |
