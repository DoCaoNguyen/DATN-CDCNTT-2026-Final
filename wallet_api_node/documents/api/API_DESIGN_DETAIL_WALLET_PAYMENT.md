...
> Ghi chú: Payload/response ưu tiên dùng `snake_case` và bám theo `ewallet_db.sql`.
...
```json
{
  ...
  "data": {
    ...
    "method": "SANDBOX_BANK",
    "status": "SUCCESS",
    "ledger_transaction_id": "00000000-0000-0000-0000-000000000401",
...
```json
{
  ...
  "data": {
    ...
    "description": "Chuyen tien an trua",
    "status": "SUCCESS",
    "ledger_transaction_id": "00000000-0000-0000-0000-000000000402",
