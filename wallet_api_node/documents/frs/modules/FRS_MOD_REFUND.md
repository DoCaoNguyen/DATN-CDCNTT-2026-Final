...
| reason | String(500) | Có | Lý do hoàn tiền |
...
| reason | String(500) | Có | Lý do hoàn |
| status | Enum | Có | PENDING / SUCCESS / FAILED / CANCELED |
| ledger_transaction_id | UUID FK | Không | Ledger REFUND |
...
|---|---|---|
| refund_status | Enum | NONE / PARTIALLY_REFUNDED / FULLY_REFUNDED |
...
| `payment_callbacks` / `webhook_events` | Webhook refund |
| `audit_logs` | Audit |
| `system_logs` | Lỗi xử lý refund |
