...
| Callback failed | COUNT(payment_callbacks WHERE status = FAILED) |
...
| # | Rule |
|---|---|
| BR-01 | Timeline lấy từ audit_logs hoặc aggregate event |
...
| `payment_callbacks` | Callback stats |
| `ledger_transactions` | Thống kê giao dịch |
| `audit_logs` | Hoạt động gần đây |
| `system_logs` | Cảnh báo lỗi |
