...
| transaction_type | Enum | Có | TOPUP / TRANSFER / PAYMENT / REFUND / ADJUSTMENT |
...
| account_type | Enum | Có | USER_WALLET / MERCHANT_BALANCE / SYSTEM_ACCOUNT |
| entry_type | Enum | Có | DEBIT / CREDIT |
...
|---|---|---|---|
| id | UUID | Có | Khóa chính |
| actor_type | Enum | Có | USER / MERCHANT / ADMIN |
...
| status | Enum | Có | PROCESSING / COMPLETED / FAILED |
...
| `audit_logs` | Ghi thao tác nghiệp vụ |
| `system_logs` | Ghi lỗi kỹ thuật, sai lệch ledger |
