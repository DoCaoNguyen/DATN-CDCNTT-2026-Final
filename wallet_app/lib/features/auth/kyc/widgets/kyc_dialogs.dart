  ...
  static void showWarning(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text("Hệ thống không nhận diện được đầy đủ thẻ. Vui lòng đặt thẻ lọt thỏm vào khung hình và chụp lại ở nơi đủ sáng.", style: TextStyle(height: 1.5, fontSize: 15)),
