  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      ...
      // XỬ LÝ LỖI 403: BẮT ĐẦU ĐẾM NGƯỢC KHÓA MÁY
        ...
        int remaining = responseData['remainingAttempts'] ?? (_remainingAttempts - 1);
        ...
        if (!errorMsg.contains('không chính xác') && !errorMsg.contains('Invalid')) {
  ...
  Future<void> _resendOtp() async {
    ...
    try {
      final response = await http.post(
        ...
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'email': '${widget.phoneNumber}@wallet.com', // Dùng email giả để qua được Validate như lúc Đăng ký
          'phone': widget.phoneNumber
        }),
      );
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(errorData['error'] ?? 'Không thể gửi lại mã'), backgroundColor: Colors.red),
        );
      }
    } catch (e) {
        ...
        return Dialog(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  activeLang == 'VIE' ? 'Thay đổi số điện thoại' : 'Change phone number',
                ...
                Text(
                  ...
                  style: const TextStyle(fontSize: 15, color: AppColors.textDark, height: 1.4),
                ),
                    ...
                    Expanded(
                      child: TextButton(
                        ...
                        child: Text(
                          ...
                          style: const TextStyle(color: AppColors.primaryPink, fontSize: 16, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              RichText(
                                ...
                                text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      text: widget.phoneNumber.isEmpty ? '0383255941' : widget.phoneNumber,
                                ...
                                children: List.generate(4, (index) {
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(color: (_hasError || _lockCountdown > 0) ? Colors.red : AppColors.border, width: 1.5),
                                    ...
                                    child: TextField(
                                      ...
                                      readOnly: _lockCountdown > 0, // Chặn nhập liệu khi bị khóa
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: (_hasError || _lockCountdown > 0) ? Colors.red : AppColors.textDark
                                      ),
                              ...
                              GestureDetector(
                                onTap: (_start == 0 && _lockCountdown == 0) ? _resendOtp : null,
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        _start > 0 
                                          ? (activeLang == 'VIE' ? 'Gửi lại mã ($_start)' : 'Resend code ($_start)') 
                                          : (activeLang == 'VIE' ? 'Gửi lại mã' : 'Resend code'),
                                        style: TextStyle(
                                          color: _start == 0 && _lockCountdown == 0 ? AppColors.primaryPink : AppColors.textLight,
                                          fontWeight: FontWeight.bold,
                                        ),
                                      ),
                                    ],
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: (_isOtpComplete && !_isLoading && _remainingAttempts > 0 && _lockCountdown == 0) ? _verifyOtp : null, 
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: (_isOtpComplete && _lockCountdown == 0) ? AppColors.primaryPink : const Color(0xFFE0E0E0),
                                ...
                                child: _isLoading 
                                  ...
                                  : Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: (_isOtpComplete && _lockCountdown == 0) ? Colors.white : AppColors.textLight,
                                      ),
                                    ),
                              ),
                            ),
