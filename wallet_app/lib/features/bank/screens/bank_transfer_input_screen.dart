...
import '../widgets/bank_transfer_input_widgets.dart';
          ...
          children: [
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    BankReceiverInfoCard(
                      bankCode: widget.bankCode,
                      displayNickname: displayNickname,
                      displayName: displayName,
                      accountNumber:
                          widget.prefilledAccountNumber ??
                    ...
                    BankTransferAmountInput(
                      ...
                      vietnameseWords:
                          _amountController.text.isNotEmpty && _parsedAmount > 0
                          ? NumberToWords.convert(_parsedAmount)
                          : '',
                    ),
                    const SizedBox(height: 16),

                    BankTransferNoteInput(
