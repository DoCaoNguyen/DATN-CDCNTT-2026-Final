...
import 'transfer_search_screen.dart'; // Import màn hình tìm kiếm bạn đã tạo ở bước trước

class TransferMainScreen extends StatelessWidget {
  final String token; // --- ĐÃ SỬA: Thêm biến nhận Token từ HomeScreen ---
  
  const TransferMainScreen({Key? key, required this.token}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        top: false, // Để gradient tràn lên status bar
        child: Column(
          children: [
