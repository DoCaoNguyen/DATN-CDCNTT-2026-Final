  ...
  void _validateAmount() {
    ...
    setState(() {
      ...
      if (val > 50000000) {
        ...
        _errorMessage =
            "Số dư Túi Thần Tài của bạn là ${_formatAmount(_wealthBagBalance)}, bạn không thể rút tiền khỏi Túi.";
    ...
    return Expanded(
      child: InkWell(
        ...
        child: Container(
          ...
          child: Text(
            NumberFormat('#,###', 'vi_VN').format(amount).replaceAll(',', '.') +
                'đ',
                  ...
                  onPressed: _isValid
                      ? () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  WithdrawMethodScreen(amount: _rawAmount),
                            ),
                          );
                        }
                      : null,
