...
class _DepositTabState extends State<DepositTab> {
  ...
  void _validateAmount() {
    ...
    setState(() {
      ...
      if (val > remaining) {
        String remainingStr =
            remaining.toInt().toString().replaceAllMapped(
              RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'),
              (Match m) => '${m[1]}.',
            ) +
            'đ';
  ...
  bool get _isValid =>
      _rawAmount >= 1000 && (_rawAmount + _wealthBagBalance) <= 500000000;
                          ...
                          children: [
                            TextSpan(
                              text: _isLoadingBalance
                                  ? "Đang tải..."
                                  : _formatAmount(_wealthBagBalance),
                              style: const TextStyle(
                  ...
                  child: Column(
                    children: [
                      ...
                      RichText(
                        text: const TextSpan(
                          text:
                              "Tiền chuyển đến Ví Mio của bạn sẽ được tự động nạp vào Túi Thần Tài và sinh lời, giúp bạn tiết kiệm thời gian nạp thủ công. ",
                          style: TextStyle(
                            color: Colors.grey,
                            fontSize: 13,
                            height: 1.4,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Text(
                                      "Hạn mức nạp mỗi ngày: 3 giao dịch",
                                      style: TextStyle(
                                        color: Colors.grey,
                                        fontSize: 13,
                                      ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                const Text(
                                  "Hạn mức nạp mỗi tháng: 50 triệu",
                                  style: TextStyle(
                                    color: Colors.grey,
                                    fontSize: 13,
                                  ),
                  ...
                  ? () {
                      if (_selectedMethod == 'bank') {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                BankTransferQrScreen(amount: _rawAmount),
                          ),
                        );
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                SecurePaymentScreen(amount: _rawAmount),
                          ),
                        );
                      }
                    }
